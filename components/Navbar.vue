  ...
  <header class="flex items-center">
    ...
    <div class="flex ml-auto" v-else>
      <div class="dropdown inline-block relative z-10">
        <button
          class="bg-white text-gray-700 font-semibold py-4 px-6 rounded inline-flex items-center text-lg"
        >
          <img
        ...
        >
          <li>
            <nuxt-link
              to="/dashboard"
              class="bg-white hover:bg-gray-100 hover:text-orange-500 py-2 px-3 block whitespace-nowrap"
          ...
          <li>
            <a
              @click="logOut()"
              class="cursor-pointer bg-white hover:bg-gray-100 hover:text-orange-500 py-2 px-3 block whitespace-nowrap"
              >Log out</a
            >
          </li>
        </ul>
